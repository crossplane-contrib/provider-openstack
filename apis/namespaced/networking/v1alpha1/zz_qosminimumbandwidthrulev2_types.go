...
type QosMinimumBandwidthRuleV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/networking/v1alpha1.QosPolicyV2
	...
	QosPolicyIDRef *v1.NamespacedReference `json:"qosPolicyIdRef,omitempty" tf:"-"`

	// Selector for a QosPolicyV2 in networking to populate qosPolicyId.
	// +kubebuilder:validation:Optional
	QosPolicyIDSelector *v1.NamespacedSelector `json:"qosPolicyIdSelector,omitempty" tf:"-"`
