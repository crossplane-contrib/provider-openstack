...
type TempurlV1InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/objectstorage/v1alpha1.ContainerV1
	...
	ContainerRef *v1.NamespacedReference `json:"containerRef,omitempty" tf:"-"`

	// Selector for a ContainerV1 in objectstorage to populate container.
	// +kubebuilder:validation:Optional
	ContainerSelector *v1.NamespacedSelector `json:"containerSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/objectstorage/v1alpha1.ObjectV1
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("name",false)
