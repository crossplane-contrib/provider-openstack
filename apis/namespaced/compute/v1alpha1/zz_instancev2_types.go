...
type InstanceV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/compute/v1alpha1.FlavorV2
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	FlavorID *string `json:"flavorId,omitempty" tf:"flavor_id,omitempty"`

	// Reference to a FlavorV2 in compute to populate flavorId.
	// +kubebuilder:validation:Optional
	FlavorIDRef *v1.NamespacedReference `json:"flavorIdRef,omitempty" tf:"-"`

	// Selector for a FlavorV2 in compute to populate flavorId.
	// +kubebuilder:validation:Optional
	FlavorIDSelector *v1.NamespacedSelector `json:"flavorIdSelector,omitempty" tf:"-"`
	...
	// Changing this creates a new server.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/compute/v1alpha1.KeypairV2
