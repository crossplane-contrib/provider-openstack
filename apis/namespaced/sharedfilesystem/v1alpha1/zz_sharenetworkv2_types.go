...
type SharenetworkV2InitParameters struct {
	...
	// shares.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/networking/v1alpha1.NetworkV2
	...
	NeutronNetIDRef *v1.NamespacedReference `json:"neutronNetIdRef,omitempty" tf:"-"`

	// Selector for a NetworkV2 in networking to populate neutronNetId.
	// +kubebuilder:validation:Optional
	NeutronNetIDSelector *v1.NamespacedSelector `json:"neutronNetIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	NeutronSubnetIDRef *v1.NamespacedReference `json:"neutronSubnetIdRef,omitempty" tf:"-"`

	// Selector for a SubnetV2 in networking to populate neutronSubnetId.
	// +kubebuilder:validation:Optional
	NeutronSubnetIDSelector *v1.NamespacedSelector `json:"neutronSubnetIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/sharedfilesystem/v1alpha1.SecurityserviceV2
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	// +listType=set
	...
	// +kubebuilder:validation:Optional
	SecurityServiceIdsRefs []v1.NamespacedReference `json:"securityServiceIdsRefs,omitempty" tf:"-"`

	// Selector for a list of SecurityserviceV2 in sharedfilesystem to populate securityServiceIds.
	// +kubebuilder:validation:Optional
	SecurityServiceIdsSelector *v1.NamespacedSelector `json:"securityServiceIdsSelector,omitempty" tf:"-"`
}
