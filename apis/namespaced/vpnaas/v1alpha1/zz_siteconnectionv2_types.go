...
type SiteConnectionV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/vpnaas/v1alpha1.IkePolicyV2
	...
	// +kubebuilder:validation:Optional
	IkepolicyIDRef *v1.NamespacedReference `json:"ikepolicyIdRef,omitempty" tf:"-"`

	// Selector for a IkePolicyV2 in vpnaas to populate ikepolicyId.
	// +kubebuilder:validation:Optional
	IkepolicyIDSelector *v1.NamespacedSelector `json:"ikepolicyIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/vpnaas/v1alpha1.IpsecPolicyV2
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	IpsecpolicyIDRef *v1.NamespacedReference `json:"ipsecpolicyIdRef,omitempty" tf:"-"`

	// Selector for a IpsecPolicyV2 in vpnaas to populate ipsecpolicyId.
	// +kubebuilder:validation:Optional
	IpsecpolicyIDSelector *v1.NamespacedSelector `json:"ipsecpolicyIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/vpnaas/v1alpha1.EndpointGroupV2
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	LocalEpGroupIDRef *v1.NamespacedReference `json:"localEpGroupIdRef,omitempty" tf:"-"`

	// Selector for a EndpointGroupV2 in vpnaas to populate localEpGroupId.
	// +kubebuilder:validation:Optional
	LocalEpGroupIDSelector *v1.NamespacedSelector `json:"localEpGroupIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PeerEpGroupIDRef *v1.NamespacedReference `json:"peerEpGroupIdRef,omitempty" tf:"-"`

	// Selector for a EndpointGroupV2 in vpnaas to populate peerEpGroupId.
	// +kubebuilder:validation:Optional
	PeerEpGroupIDSelector *v1.NamespacedSelector `json:"peerEpGroupIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/vpnaas/v1alpha1.ServiceV2
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	VpnserviceIDRef *v1.NamespacedReference `json:"vpnserviceIdRef,omitempty" tf:"-"`

	// Selector for a ServiceV2 in vpnaas to populate vpnserviceId.
	// +kubebuilder:validation:Optional
	VpnserviceIDSelector *v1.NamespacedSelector `json:"vpnserviceIdSelector,omitempty" tf:"-"`
}
