...
type ListenerV2InitParameters struct {
	...
	// 2.8.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/keymanager/v1alpha1.SecretV1
	...
	ClientCATLSContainerRefRef *v1.NamespacedReference `json:"clientCaTlsContainerRefRef,omitempty" tf:"-"`

	// Selector for a SecretV1 in keymanager to populate clientCaTlsContainerRef.
	// +kubebuilder:validation:Optional
	ClientCATLSContainerRefSelector *v1.NamespacedSelector `json:"clientCaTlsContainerRefSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/lb/v1alpha1.LoadbalancerV2
