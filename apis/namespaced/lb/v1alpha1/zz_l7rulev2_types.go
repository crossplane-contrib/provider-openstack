...
type L7RuleV2InitParameters struct {
	...
	// L7 Rule.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/lb/v1alpha1.L7PolicyV2
	...
	L7PolicyIDRef *v1.NamespacedReference `json:"l7policyIdRef,omitempty" tf:"-"`

	// Selector for a L7PolicyV2 in lb to populate l7policyId.
	// +kubebuilder:validation:Optional
	L7PolicyIDSelector *v1.NamespacedSelector `json:"l7policyIdSelector,omitempty" tf:"-"`
