...
type QosAssociationV3InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/blockstorage/v1alpha1.QosV3
	...
	QosIDRef *v1.NamespacedReference `json:"qosIdRef,omitempty" tf:"-"`

	// Selector for a QosV3 in blockstorage to populate qosId.
	// +kubebuilder:validation:Optional
	QosIDSelector *v1.NamespacedSelector `json:"qosIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/blockstorage/v1alpha1.VolumeTypeV3
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	VolumeTypeIDRef *v1.NamespacedReference `json:"volumeTypeIdRef,omitempty" tf:"-"`

	// Selector for a VolumeTypeV3 in blockstorage to populate volumeTypeId.
	// +kubebuilder:validation:Optional
	VolumeTypeIDSelector *v1.NamespacedSelector `json:"volumeTypeIdSelector,omitempty" tf:"-"`
}
