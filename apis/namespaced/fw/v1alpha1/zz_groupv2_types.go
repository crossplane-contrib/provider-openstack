...
type GroupV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/fw/v1alpha1.PolicyV2
	...
	EgressFirewallPolicyIDRef *v1.NamespacedReference `json:"egressFirewallPolicyIdRef,omitempty" tf:"-"`

	// Selector for a PolicyV2 in fw to populate egressFirewallPolicyId.
	// +kubebuilder:validation:Optional
	EgressFirewallPolicyIDSelector *v1.NamespacedSelector `json:"egressFirewallPolicyIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	IngressFirewallPolicyIDRef *v1.NamespacedReference `json:"ingressFirewallPolicyIdRef,omitempty" tf:"-"`

	// Selector for a PolicyV2 in fw to populate ingressFirewallPolicyId.
	// +kubebuilder:validation:Optional
	IngressFirewallPolicyIDSelector *v1.NamespacedSelector `json:"ingressFirewallPolicyIdSelector,omitempty" tf:"-"`
