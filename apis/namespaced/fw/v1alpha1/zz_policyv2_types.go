...
type PolicyV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/fw/v1alpha1.RuleV2
	...
	RulesRefs []v1.NamespacedReference `json:"rulesRefs,omitempty" tf:"-"`

	// Selector for a list of RuleV2 in fw to populate rules.
	// +kubebuilder:validation:Optional
	RulesSelector *v1.NamespacedSelector `json:"rulesSelector,omitempty" tf:"-"`
