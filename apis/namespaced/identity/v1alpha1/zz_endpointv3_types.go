...
type EndpointV3InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/identity/v1alpha1.ServiceV3
	...
	EndpointRegionRef *v1.NamespacedReference `json:"endpointRegionRef,omitempty" tf:"-"`

	// Selector for a ServiceV3 in identity to populate endpointRegion.
	// +kubebuilder:validation:Optional
	EndpointRegionSelector *v1.NamespacedSelector `json:"endpointRegionSelector,omitempty" tf:"-"`
