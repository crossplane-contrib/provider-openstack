...
type TransferAcceptV2InitParameters struct {
	...
	// The transfer key.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/dns/v1alpha1.TransferRequestV2
	...
	// +kubebuilder:validation:Optional
	ZoneTransferRequestIDRef *v1.NamespacedReference `json:"zoneTransferRequestIdRef,omitempty" tf:"-"`

	// Selector for a TransferRequestV2 in dns to populate zoneTransferRequestId.
	// +kubebuilder:validation:Optional
	ZoneTransferRequestIDSelector *v1.NamespacedSelector `json:"zoneTransferRequestIdSelector,omitempty" tf:"-"`
}
