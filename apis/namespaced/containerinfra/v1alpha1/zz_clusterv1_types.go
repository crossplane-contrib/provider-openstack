...
type ClusterV1InitParameters struct {
	...
	FixedNetworkRef *v1.NamespacedReference `json:"fixedNetworkRef,omitempty" tf:"-"`

	// Selector for a NetworkV2 in networking to populate fixedNetwork.
	// +kubebuilder:validation:Optional
	FixedNetworkSelector *v1.NamespacedSelector `json:"fixedNetworkSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	FixedSubnetRef *v1.NamespacedReference `json:"fixedSubnetRef,omitempty" tf:"-"`

	// Selector for a SubnetV2 in networking to populate fixedSubnet.
	// +kubebuilder:validation:Optional
	FixedSubnetSelector *v1.NamespacedSelector `json:"fixedSubnetSelector,omitempty" tf:"-"`
